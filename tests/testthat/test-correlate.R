...
test_that("hd_run_correlation works with different inputs", {
  ...
  result_df <- hd_run_correlation(df)
  ...
  result_df2 <- hd_run_correlation(df1, df2)
  ...
  result_mat2 <- hd_run_correlation(mat1, mat2)
  ...
  expect_error(hd_run_correlation(mat1, mat3), "incompatible dimensions")
})
