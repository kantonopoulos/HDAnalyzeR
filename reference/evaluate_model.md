...
`evaluate_model()` finalizes the model using the best hyperparameters
and evaluates the model using the test set. It calculates the accuracy,
sensitivity, specificity, AUC, and confusion matrix. It also plots the
ROC curve.
