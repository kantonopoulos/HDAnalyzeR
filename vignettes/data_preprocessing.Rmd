...
Now, we will perform a quality control check on the data. `hd_qc_summary()` will return the percentage of missing values for each column and row and histograms of their distributions both for data and metadata, the protein-protein correlation and the metadata variable distributions. 
