...
Finally, let's perform an automated literature search using the `hd_literature_search()`. The function requires a list with disease names as names and proteins as values. We will create the list, run the search and preview the results.
