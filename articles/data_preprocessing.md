...
#> [1] viridis_0.6.5     viridisLite_0.4.3 HDAnalyzeR_1.0.1 
#> 
...
#> [10] timechange_0.4.0    lifecycle_1.0.5     tokenizers_0.3.0   
#> [13] survival_3.8-3      magrittr_2.0.4      compiler_4.5.2     
#> [16] rlang_1.1.7         sass_0.4.10         tools_4.5.2        
#> [19] utf8_1.2.6          yaml_2.3.12         tidytext_0.4.3     
#> [22] data.table_1.18.2.1 knitr_1.51          askpass_1.2.1      
#> [25] labeling_0.4.3      htmlwidgets_1.6.4   reticulate_1.45.0  
#> [28] RColorBrewer_1.1-3  withr_3.0.2         purrr_1.2.1        
#> [31] desc_1.4.3          nnet_7.3-20         grid_4.5.2         
#> [34] embed_1.2.2         future_1.69.0       ggplot2_4.0.2      
...
#> [46] RSpectra_0.16-2     future.apply_1.20.2 cachem_1.1.0       
#> [49] splines_4.5.2       parallel_4.5.2      ggplotify_0.1.3    
#> [52] yulab.utils_0.2.4   vctrs_0.7.1         hardhat_1.4.2      
#> [55] Matrix_1.7-4        jsonlite_2.0.0      gridGraphics_0.5-1 
#> [58] listenv_0.10.0      systemfonts_1.3.1   gower_1.0.2        
#> [61] tidyr_1.3.2         jquerylib_0.1.4     recipes_1.3.1      
#> [64] glue_1.8.0          parallelly_1.46.1   pkgdown_2.2.0      
#> [67] codetools_0.2-20    uwot_0.2.4          RcppAnnoy_0.0.23   
...
#> [88] broom_1.0.12        bslib_0.10.0        class_7.3-23       
#> [91] Rcpp_1.1.1          gridExtra_2.3       prodlim_2025.04.28 
#> [94] xfun_0.56           fs_1.6.6            tidyheatmaps_0.2.1 
#> [97] pkgconfig_2.0.3
```
